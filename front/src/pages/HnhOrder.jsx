  ...
  return (
    ...
    <div className="order-container">
      {userInfo ? (
        <>
        <h1>주문 확인</h1>
        <h3> <span className="order-name">{userInfo.userId}</span>님의 주문이 완료되었습니다<br></br> 주문번호 {orderNumber}</h3>
        <div className="order-list">   
          <h1>구매정보</h1>
        <ul>
          <li>{orderList.pizzaLeft}+{orderList.pizzaRight}x{orderList.pizzaQty}</li>
          ...
          {orderList.totalPrice && <li>총 금액<span className="result-money">{orderList.totalPrice}</span>원</li> }
        </ul>
        </div>
