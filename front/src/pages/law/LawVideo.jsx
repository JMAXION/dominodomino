...
export default function LawVideo({ depth2 }) {
      ...
      <div className="law lawVideo">
        ...
        <div className="lawVideo">
          ...
          <div>
            ...
            <table border="1px" className="lawVideo-table-1">
              <thead>
                <tr>
                  <td>종류</td>
                  <td>설치위치</td>
          ...
          <div>
            ...
            <table border="1px" className="lawVideo-table-2">
              <thead>
                <tr>
                  <td>대상</td>
                  <td>촬영시간</td>
          ...
          <div>
            ...
            <table border="1px" className="lawVideo-table-3">
              <thead>
                <tr>
                  <td>대상</td>
                  <td>촬영시간</td>
            ...
            <p>
              ※ 또한 개인정보포털 드론 촬영사실 조회를 통해서도 확인이
              가능합니다.
            </p>
