...
export default function LawTeen({ depth2 }) {
  ...
  return (
    <div className="content">
      ...
      <div className="law">
        ...
        <div className="lawTeen">
          <div>
            <h3>제1조. 청소년 보호 관리조치</h3>
            <p>
              회사는 성인인증 장치 운영 및 유해매체물의 표시를 적용하여,
              청소년에 대한 유해정보의 접근과 노출을 사전에 차단하고 있으며
              청소년 유해상품의 구매도 제한하고 있습니다.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              정보보호에 관한 법률 및 청소년보호법 등 관련법령 및 유해정보 발견
              시 처리 방법 등을 교육하고 있습니다.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              위하여 청소년보호책임자를 지정하고 담당부서를 운영하고 있으니,
              4항을 참고하여 전화나 메일주시면 상담 및 고충처리 요청할 수
              있습니다.
            </p>
          </div>
          <div className="lawTeen-num4">
